(function(){
    ...
    getBeianCode = function() {
        ...
        $('#beian-code-refresh').html('<img class="form-control" style="padding: 0;" src="http://beian.miit.gov.cn/getVerifyCode?'+rand+'">');
    },
    writeResult = function(type, output, append, escape){
                ...
                case 'translate':
                    ...
                    try{
                        $.getJSON(url + formData.translate_string, function(detail){
                            ...
                            writeResult(type, result, false, false);
